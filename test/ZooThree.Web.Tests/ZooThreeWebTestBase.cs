...
{
    public abstract class ZooThreeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ZooThreeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ZooThreeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ZooThreeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ZooThreeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ZooThreeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ZooThreeDbContext, Task<T>> func)
        {
            T result;
