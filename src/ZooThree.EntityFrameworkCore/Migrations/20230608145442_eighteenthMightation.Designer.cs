...
namespace ZooThree.Migrations
{
    ...
    [Migration("20230608145442_eighteenthMightation")]
    partial class eighteenthMightation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZooThree.Domain.Death", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AnimalDeaths");
                });

            modelBuilder.Entity("ZooThree.Domain.Enclosure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZooThree.Domain.Species", b =>
                {
                    ...
                    b.Property<int>("NumberBirth")
                        .HasColumnType("int");

                    b.Property<int>("NumberDead")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ZooThree.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ZooThree.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ZooThree.Domain.Person", b =>
                {
                    b.HasOne("ZooThree.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
